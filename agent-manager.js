//Manager(Agent as tool) - Use another agent as a tool to handle the query. The manager agent will use the other agent as a tool to handle the query and return the result to the user.

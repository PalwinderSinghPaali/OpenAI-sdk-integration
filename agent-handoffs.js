//Handoffs - Simply transfer the query to the right agent based on the query and the agent's expertise. The reception agent is the first point of contact for the user and it will handoff the query to the right agent based on the query and the agent's expertise.
